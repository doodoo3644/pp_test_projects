// query for gto hwlist page //

$(document).ready(function() {

$.post("/cgi-bin/pp/ose/gto/listTables.cgi", {}, function(data) {
   $("#tab1").html(data);
...
$('#button').click(function() {
   var table   = $("#tablist").val();

   $.post("/cgi-bin/pp/ose/gto/showTable.cgi", {table : table}, function(data) {
         $("#show").html(data);
...
/*
   ...
   $('#button').click(function() {
      ...
      $.post("/cgi-bin/pp/ose/network/listIPaddr.cgi", {vlan : vlan, ipaddr : ipaddr}, function(data) {
         $("#show").html(data);
